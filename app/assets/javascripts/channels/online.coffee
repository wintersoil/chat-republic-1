    ...
    if data.hasOwnProperty('arrayez')
      ...
      while i < data.arrayez.length
        ...
        if eventType == 'appear'
          ...
          stringyHTML = '<img src="https://vectr.com/wintersoil/a1gzED9FjB.svg?width=640&height=640&select=a1gzED9FjBpage0" height="70px" width="70px"/><div class="inner-text">'+ $('#user_'+userId).html() +' is online now</div>'
