class ChatroomController < ApplicationController
  ...
  def mp3audio
    ...
    s3 = Fog::AWS::Storage.new(:provider => "AWS", :aws_access_key_id => ENV['S3_ACCESS_KEY'], :aws_secret_access_key => ENV['S3_SECRET_KEY'], :region => "ca-central-1")
    directory = s3.directories.get("uploads1")
